...
+ (BOOL)iPhoneX {
    ...
    NSArray<NSString *> *devices = @[@"iPhone10,3", @"iPhone10,6", @"iPhone11,8", @"iPhone11,2", @"iPhone11,4", @"iPhone11,6", @"iPhone12,1", @"iPhone12,3", @"iPhone12,5", @"iPhone12,8", @"iPhone13,2", @"iPhone13,3", @"iPhone13,4", @"iPhone13,1", @"iPhone14,5", @"iPhone14,2", @"iPhone14,3", @"iPhone14,4"];
    return [devices containsObject:code];
}
